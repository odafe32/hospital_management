...
<nav class="navbar">
    <div class="nav_container">
        ...
        <ul class="nav-links">
            ...
            <a  class="button" href="#" > <li>Book Appointment</li></a>
        </ul>
        <div class="burger">
            <div class="line1"></div>
            <div class="line2"></div>
    ...
    <div class="container">
        <div class="forms">
            <div class="form login">
                <span class="title">User's Login</span>
            ...
            <div class="form signup form2">
                <span class="title">User's  Registration</span>
                ...
                <form action="register.php" method="POST">
                    ...
                    <div class="input-field">
                        <input type="tel" class="password" placeholder="Phone No" name="phone" required>
                        <i class="uil uil-phone icon"></i>
                    </div>
                    <div class="input-field">
                        <input type="date" class="password" placeholder="Date Of Birth" name="dob" required>
                        <i class="uil uil-calender icon"></i>
                    </div>
                    <div class="input-field">
                        <input type="tel" class="password" placeholder="Create a password" name="password"  required>
                        <i class="uil uil-lock icon"></i>
                        <i class="uil uil-eye-slash showHidePw"></i>
                    </div>
